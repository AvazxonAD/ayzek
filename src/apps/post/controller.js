...
class PostController {
  static async get(req, res) {
    const { page = 1, limit = 10, id, video, order_by = "created_at", order_type = "ASC" } = req.query;
    const result = await PostService.get(parseInt(page), parseInt(limit), id, video, order_by, order_type);
